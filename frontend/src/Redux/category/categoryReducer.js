import { DELETE_CATEGORY, SET_ALL_CATEGORY, SET_CATEGORY_COUNT, SET_CATEGORY_DETAIL, SET_CATEGORY_SEARCH, SET_CREATED_CATEGORY, SET_CREATE_CATEGORY_ERROR } from "../../Constant/reducerConstants"
...
const categoryData = (state=[], action) => {
    switch (action.type) {
        ...
        case DELETE_CATEGORY:
            return{
                ...state,
                category: state.Categorys.filter((category)=>category.id !== action.id)
            }
